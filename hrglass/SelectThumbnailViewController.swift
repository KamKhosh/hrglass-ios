...
//
// -- ALLOWS USER TO SELECT THUMBNAIL FROM THUMBNAILS GENERATED BY THE VIDEO
...
class SelectThumbnailViewController: UIViewController {
    ...
    override func viewDidAppear(_ animated: Bool) {
        ...
        if selectedObject != nil{
            //if a video already exists as an object
            ...
            //else if video exists in documents and we have the path
...
//                print(Float64(i))
    ...
    //gets an image from the video at the specified time
    ...
    //shows thumbnail processing view
    ...
    //set thumbnail and unwind based on parent view
    ...
    //thumbnail slider storyboard action
