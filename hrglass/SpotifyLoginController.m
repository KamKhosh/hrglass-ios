...
@interface SpotifyLoginController () <SFSafariViewControllerDelegate, WebViewControllerDelegate, SPTStoreControllerDelegate>
...
@implementation SpotifyLoginController
