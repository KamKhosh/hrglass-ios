...
#import "Config.h"
#import "SpotifyStreamViewController.h"
#import <SpotifyAuthentication/SpotifyAuthentication.h>
#import <SpotifyMetadata/SpotifyMetadata.h>
#import <AVFoundation/AVFoundation.h>

@interface SpotifyStreamViewController () <SPTAudioStreamingDelegate>
...
@implementation SpotifyStreamViewController
...
- (void)audioStreaming:(SPTAudioStreamingController *)audioStreaming didReceiveMessage:(NSString *)message {
    UIAlertController *alertView = [UIAlertController alertControllerWithTitle:@"Message from Spotify" message:message preferredStyle:UIAlertControllerStyleActionSheet];
